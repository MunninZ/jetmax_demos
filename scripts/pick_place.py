...
class ColorSortingState:
    ...
    def load_camera_params(self):
        ...
        self.camera_params = rospy.get_param('/block_params', self.camera_params)
...
def set_target(color_name, destination_position):
    color_ranges = rospy.get_param('/color_range_list', {})
    state.target_colors[color_name] = color_ranges[color_name]
    state.target_positions = destination_position
...
if __name__ == '__main__':
    ...
    # set color of target object to be picked and placed
    # set_target('<object color name>', destination position) 
    # red: 'red', (235, -12, 85),
    # green: 'green', (235, -12 + 52, 85),
    # blue: 'blue', (235, -12 + 52 * 2, 85)

    set_target('blue', (235, -12, 85))
    #set_target('green', (235, -12 + 52, 85))
    #set_target('blue', (235, -12 + 52 * 2, 85))
